...
class LoSh2D(nn.Module):
    ...
    def forward_core(self, x: torch.Tensor):
        ...
        # xs = torch.cat([x_hwwh, torch.flip(x_hwwh, dims=[-1])], dim=1) # (1, 4, 192, 3136) (B,K,C,L)
        # xs, xs_ids = loshscan(x, scan_len=4)
        ...
        print("loshscan time:", (end-start)*24, " s")
        ...
        torch.cuda.synchronize()
        start = time.time()
        y1, y2, y3, y4 = losh_decoup(out_y, xs_ids)
        torch.cuda.synchronize()
        end = time.time()
        print("loshscan decomp time:", (end-start)*24, " s")
...
if __name__ == '__main__':
    ...
    # print(ret_dict['layers'])
    # ret_dict = ret_dict['layers'][2] # 一共有6层，每层的计算量和参数了占比16.36% 16.36% 16.36% 16.36% 16.36% 16.36%
    # ret_dict = ret_dict['layers'][2]['0'][2] # residual_group：14.57% + conv 1.79%
    # ret_dict = ret_dict['layers'][2]['0'][2]['residual_group'][2] blocks：14.57% 
    # ret_dict = ret_dict['layers'][2]['0'][2]['residual_group'][2]['blocks'][2] #一共有6层，每层的计算量和参数了占比 2.43 %
    # ret_dict = ret_dict['layers'][2]['0'][2]['residual_group'][2]['blocks'][2]['0'][2] # 计算量和参数： self_attention：1.22 %， conv_blk：1.20/1.21 %
    # ret_dict = ret_dict['layers'][2]['0'][2]['residual_group'][2]['blocks'][2]['0'][2]['self_attention'][2] in_proj: 0.8/0.79 %, out_proj: 0.4/0.4 %, conv2d: 0.02/0.02 %
    # ret_dict = ret_dict['layers'][2]['0'][2]['residual_group'][2]['blocks'][2]['0'][2]['conv_blk'][2]['cab'][2]
