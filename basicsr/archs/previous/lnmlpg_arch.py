...
if __name__ == '__main__':
    ...
    net = LnMLPG(img_size=(64, 64), embed_dim=60, d_state=1, ssm_ratio=1.0, dynamic_ids=False, batch_size=1,mlp_ratio=1.5).cuda()
