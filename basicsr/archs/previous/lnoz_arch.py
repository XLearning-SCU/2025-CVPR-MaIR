...
class VSSBlock(nn.Module):
    def __init__(
        ...
        self.self_attention = LoShNoZ(d_model=hidden_dim, d_state=d_state,expand=expand,dropout=attn_drop_rate, input_resolution=input_resolution, **kwargs)
...
if __name__ == '__main__':
    ...
    net = LNoZ(img_size=(64, 64), d_state=1, dynamic_ids=False, batch_size=1).cuda()
