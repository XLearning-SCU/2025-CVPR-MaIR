...
class LoSSNEING(nn.Module):
    r""" LoShNet Model
           A PyTorch impl of : `A Simple Baseline for Image Restoration with State Space Model `.
           
           Local-Scan Shift-Path Network without einsum + Group Convolution
...
if __name__ == '__main__':
    ...
    net = LoSSNEING(img_size=(64, 64), d_state=1, dynamic_ids=False, batch_size=1).cuda()
