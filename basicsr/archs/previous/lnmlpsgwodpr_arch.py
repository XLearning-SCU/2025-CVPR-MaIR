...
class VSSBlock(nn.Module):
    ...
    def forward(self, input, losh_ids, x_size):
        ...
        x = self.ln_1(input)
        x = input*self.skip_scale + self.self_attention(x, losh_ids)
...
class LnMLPSGwoDPR(nn.Module):
    ...
    def __init__(self,
        ...
        super(LnMLPSGwoDPR, self).__init__()
        num_in_ch = in_chans
        num_out_ch = in_chans
        num_feat = 64
...
if __name__ == '__main__':
    ...
    net = LnMLPSGwoDPR(img_size=(64, 64), embed_dim=60, d_state=1, ssm_ratio=1.2, dynamic_ids=False, batch_size=1,mlp_ratio=1.5).cuda()
