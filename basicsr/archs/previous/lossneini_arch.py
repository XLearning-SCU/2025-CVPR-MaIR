...
class LoSh2D(nn.Module):
    ...
    def forward_core(self, x: torch.Tensor, 
        ...
        dt_projs_bias = self.dt_projs_bias.view(-1).to(torch.float) # [K*c]
...
if __name__ == '__main__':
    ...
    net = LoSSNEINI(img_size=(64, 64), d_state=1, mlp_ratio=1.5,dynamic_ids=False, batch_size=1).cuda()
